...
public class YeePay {
	...
	public static String buildHmac(String p0_Cmd, String p1_MerId,
		...
		return YeePay.hmacSign(sValue.toString(), keyValue);
	}
	...
	public static boolean verifyCallback(String hmac, String p1_MerId,
		...
		String sNewString = YeePay.hmacSign(sValue.toString(), keyValue);
	...
	public static String getpayUrl(String orderNumber, String orderPrice) {
		...
		String hmac = YeePay.buildHmac(p0_Cmd, p1_MerId, p2_Order, p3_Amt,
